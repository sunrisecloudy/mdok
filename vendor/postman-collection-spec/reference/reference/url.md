<!-- Archived from https://learning.postman.com/collection-format/page-data/reference/url/page-data.json (Wayback Machine snapshot 20230411164928). Source: postmanlabs/postman-docs rendered by learning.postman.com. -->
...
| [variable](https://github.com/postmanlabs/schemas/blob/da7578c2d71c46de2d39d04fbeebc26570591a44/schemas/draft-07/v2.1.0/collection/url.json#L101) | [#variable](/collection-format/reference/variable) | `false` | Stores collection variables with the syntax `/path/:variableName/to/somewhere`. |
