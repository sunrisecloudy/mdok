<!-- Archived from https://learning.postman.com/collection-format/page-data/advanced-concepts/variables/page-data.json (Wayback Machine snapshot 20240421181709). Source: postmanlabs/postman-docs rendered by learning.postman.com. -->
...
A variable is defined using a [variable-list](/collection-format/reference/variable-list/), which is an array of [variable objects](/collection-format/reference/variable/). Each object has a key-value pair and some metadata that represents different parts of your variable.
...
| [description](https://github.com/postmanlabs/schemas/blob/develop/schemas/draft-07/v2.1.0/collection/variable.json#L33) | [reference-object](/collection-format/reference/description/) | A description of the variable. |
...
Item-scoped variables are scoped to the [item](/collection-format/reference/item/) unit of a collection.
