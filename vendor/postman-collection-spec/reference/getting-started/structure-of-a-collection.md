<!-- Archived from https://learning.postman.com/collection-format/page-data/getting-started/structure-of-a-collection/page-data.json (Wayback Machine snapshot 20260107232532). Source: postmanlabs/postman-docs rendered by learning.postman.com. -->
...
At minimum, the `info` property contains the collection name and schema. You can also [define a version](/collection-format/reference/version) or provide a [description](/collection-format/reference/description) of your collection in the `info` property.
