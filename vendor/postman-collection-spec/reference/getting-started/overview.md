<!-- Archived from https://learning.postman.com/collection-format/page-data/getting-started/overview/page-data.json (Wayback Machine snapshot 20230422213037). Source: postmanlabs/postman-docs rendered by learning.postman.com. -->
