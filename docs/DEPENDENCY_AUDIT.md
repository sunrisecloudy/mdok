...
- Active metadata packages: 15
- Cargo.lock records: 294 (294 unique name/version/source records; 280 registry, 14 local/path)
...
| `command-group` | direct runtime | mdok-command (runtime) | default features | See source evidence and manifest consumers. Files: `src/lib.rs` |
